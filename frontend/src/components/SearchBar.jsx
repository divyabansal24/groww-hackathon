...
export function SearchBar({ currentWatchlist, onAddStock }) {
    ...
    <div className="relative mb-6" ref={dropdownRef}>
      <div className="relative">
        ...
        <input
          ...
          placeholder="Search Indian stocks to add (e.g. RELIANCE, TCS, INFY)..."
                ...
                >
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-3xs font-medium uppercase px-1.5 py-0.5 rounded bg-slate-100 text-slate-500">
                        {stock.exchange || 'NSE'}
                      </span>
                    </div>
